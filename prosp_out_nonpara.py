...
prosp_dir = '/orange/narayanan/s.lower/prospector/simba_runs/'
...
pdfile = pd_dir+'/grid_physical_properties.305_galaxy'+str(int(galaxy))+'.npz'
...
data = {'Galaxy' : galaxy,  'SFR_50' : sfr_50[0][::-1], 'SFR_16' : sfr_16[0][::-1],
        ...
        'Z_84' : Z_84, 'Massfrac' : massfrac_50, 'Massfrac16' : massfrac_16, 'Massfrac84' : massfrac_84, 'Spec': spec, 'theta_labels': thetas, 'SPS': sps}


np.savez(prosp_dir+'/galaxy_'+str(galaxy)+'_withmod.npz', data=data)
